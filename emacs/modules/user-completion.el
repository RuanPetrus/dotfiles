...
(user-package-install-package 'cape)
(user-package-install-package 'consult)
(user-package-install-package 'corfu)
(user-package-install-package 'corfu-terminal)
(user-package-install-package 'embark)
(user-package-install-package 'embark-consult)
